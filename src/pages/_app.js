...
export default function App({ Component, pageProps }) {
  ...
  return (
    <ThemeProvider>
      <AuthProvider>
        <Head>
          <title>Invincible Fitness</title>
          <meta name="description" content="Invincible Fitness Management System" />
          ...
          <meta name="apple-mobile-web-app-title" content="InvFitness" />
